...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($query->rowCount() > 0) {
            ...
            $error = "Mật khẩu hiện tại bị sai";
        }
    }
?>
    <!DOCTYPE html>
    ...
    <head>
        ...
        <title>QLHS Admin | Đổi mật khẩu</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Đổi mật khẩu admin</h2>
                                </div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <form name="chngpwd" method="post" \ onSubmit="return valid();">
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Mật khẩu hiện tại</label>
                                                        <div class="">
                                                    ...
                                                    <div class="form-group has-success">
                                                        <label for="success" class="control-label">Mật khẩu mới</label>
                                                        <div class="">
