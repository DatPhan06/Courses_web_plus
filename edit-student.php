                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Cập nhật thông tin sinh viên</h2>
                                                    ...
                                                    foreach ($results as $result) {  ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                if ($gndr == "Female") {
                                                                ?>
                                                                    <input type="radio" name="gender" value="Male" required="required">Nam <input type="radio" name="gender" value="Female" required="required" checked>Nữ <input type="radio" name="gender" value="Other" required="required">Khác
                                                                <?php } ?>
                                                                <?php
                                                                if ($gndr == "Other") {
                                                                ?>
                                                                    <input type="radio" name="gender" value="Male" required="required">Nam <input type="radio" name="gender" value="Female" required="required">Nữ <input type="radio" name="gender" value="Other" required="required" checked>Khác
                                                                <?php } ?>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                if ($stats == "1") {
                                                                ?>
                                                                    <input type="radio" name="status" value="1" required="required" checked>Kích hoạt <input type="radio" name="status" value="0" required="required">Khóa
                                                                <?php } ?>
                                                                <?php
                                                                if ($stats == "0") {
                                                                ?>
                                                                    <input type="radio" name="status" value="1" required="required">Kích
                                                                    hoạt <input type="radio" name="status" value="0" required="required" checked>Khóa
                                                                <?php } ?>
