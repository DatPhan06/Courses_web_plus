...
<head>
    ...
    <title>SRMS Admin | Tạo lớp học</title>
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li class="active">Tạo lớp học</li>
                                </ul>
                            </div>
                                                ...
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <input type="text" name="section" class="form-control"
                                                            required="required" id="success">
                                                        <span class="help-block">Ví dụ: A,B,C etc</span>
                                                    </div>
                                                </div>
                                                <div class="form-group has-success">
                                                    ...
                                                    <div class="">
                                                        <button type="submit" name="submit"
                                                            class="btn btn-success btn-labeled">Xác nhận<span
