...
<head>
    ...
    <title>SRMS Admin | Quản lí sinh viên</title>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body p-20">
                                            ...
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <tbody>
                                                    <?php $sql = "SELECT students.StudentName,students.RollId,students.RegDate,students.StudentId,students.Status,classes.ClassName,classes.ClassNameNumeric,classes.Section from students join classes on classes.id=students.ClassId";
