...
<head>
    ...
    <link rel="stylesheet" href="front-end/css/icheck/skins/flat/blue.css">
        ...
        <div class="login-bg-color bg-black-300">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel login-box">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                <h4>Hệ thống quản lí sinh viên</h4>
                            </div>
                        </div>
                        <div class="panel-body p-20">
                            ...
                            <form action="result.php" method="post">
                                <div class="form-group">
                                    <label for="rollid">Điền mã sinh viên</label>
                                    <input type="text" class="form-control" id="rollid" placeholder="Nhập mã sinh viên" autocomplete="off" name="rollid">
                                </div>
                                <div class="form-group">
                                        ...
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {   ?>
                                                <option value="<?php echo htmlentities($result->id); ?>">
                                                    ...
                                                    &nbsp;Năm <?php echo htmlentities($result->ClassNameNumeric); ?></option>
                                        <?php }
                                        } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group mt-20">
                                    <div class="">
                                        ...
                                        <button type="submit" class="btn btn-success btn-labeled pull-right">Tìm
                                            kiếm<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                    ...
                    <!-- /.panel -->
                    <p class="text-muted text-center"><small>Tra cứu quản lí thông tin sinh viên</small></p>
                </div>
