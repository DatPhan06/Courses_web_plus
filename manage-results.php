...
?>
    ...
    <head>
        ...
        <title>QLHS Admin | Quản lí kết quả</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Quản lí kết quả</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Kết quả</li>
                                        <li class="active">Quản lí kết quả</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h5>Xem thông tin kết quả của sinh viên</h5>
                                                </div>
                                            </div>
                                            <?php if ($msg) { ?>
                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php $sql = "SELECT  distinct students.StudentName,students.RollId,students.RegDate,students.StudentId,students.Status,classes.ClassName, classes.ClassNameNumeric,classes.Section from result join students on students.StudentId=result.StudentId  join classes on classes.id=result.ClassId";
                                                            ...
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo htmlentities($result->ClassName); ?>&nbsp;
                                                                        ...
                                                                        &nbsp;Năm <?php echo htmlentities($result->ClassNameNumeric); ?>
                                                                    </td>
                                                                    <td><?php echo htmlentities($result->RegDate); ?></td>
                                                                    <td><?php if ($result->Status == 1) {
                                                                            echo htmlentities('Kích hoạt');
                                                                        } else {
                                                                            echo htmlentities('Bị khóa');
                                                                        }
                                                                        ?></td>
                                                                    <td>
