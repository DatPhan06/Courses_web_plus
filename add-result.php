...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        for ($i = 0; $i < count($mark); $i++) {
            ...
            if ($lastInsertId) {
                $msg = "Thêm thông tin kết quả thành công";
            } else {
                $error = "Dính lỗi rồi hãy thử lại sau";
            }
        }
    }
?>
    ...
    <head>
        ...
        <title>QLHS Admin | Khai báo kết quả </title>
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Khai báo kết quả</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Khai báo kết quả</li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post">
                                                            ...
                                                            if ($query->rowCount() > 0) {
                                                                foreach ($results as $result) {   ?>
                                                                    <option value="<?php echo htmlentities($result->id); ?>">
                                                                        ...
                                                                        Số lớp-<?php echo htmlentities($result->Section); ?>
                                                                    </option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                ...
                                                <div class="form-group">
                                                    <label for="date" class="col-sm-2 control-label ">Tên sinh viên</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-2 col-sm-10">
                                                        <button type="submit" name="submit" id="submit" class="btn btn-primary">Khai báo kết quả</button>
                                                    </div>
                                                </div>
                                            </form>
