...
?>
    ...
    <head>
        ...
        <title>QLHS Admin | Quản lí thông báo</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Quản lí thông báo</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li>Thông báo</li>
                                        <li class="active">Quản lí thông báo</li>
                                    </ul>
                                </div>
                                                        ...
                                                        if ($query->rowCount() > 0) {
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="manage-notices.php?id=<?php echo htmlentities($result->id); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa thông báo này?');">
