...
?>
    ...
    <head>
        ...
        <title>QLHS Admin | Quản lí Môn học</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Quản lí môn học</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li> Môn học</li>
                                        <li class="active">Quản lí môn học</li>
                                    </ul>
                                </div>
                                        ...
                                        <div class="panel">
                                            ...
                                            <?php if ($msg) { ?>
                                                <div class="alert alert-success left-icon-alert" role="alert">
                                                    <strong>Welldone!</strong><?php echo htmlentities($msg); ?>
